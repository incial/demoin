  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-lg md:text-xl leading-relaxed text-background/80">
          <motion.p 
          ...
          >
            ...
            came together because we love making things that matter. No corporate jargon. 
            No stuffy meetings. Just honest conversations and meaningful work.
          </motion.p>
        ...
        <motion.p 
          ...
          animate={isVisible ? { opacity: 0.5, rotate: 2 } : {}}
